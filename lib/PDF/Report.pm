...
sub addText {
  ...
  #warn "addText: self->hPos " . $self->{hPos} . ", text $text, hPos $hPos, textWidth $textWidth, textHeight $textHeight";
  ...
  #warn "  self->hPos " . $self->{hPos} . ", text $text, hPos $hPos, textWidth $textWidth, textHeight $textHeight";
