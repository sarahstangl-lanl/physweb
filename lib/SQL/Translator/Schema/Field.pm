...
our %type_mapping = (
  ...
  date => SQL_DATE + 4, # SQL_DATE and SQL_DATETIME currently both map to 9 in /usr/local/lib/perl5/site_perl/5.16/mach/auto/DBI/dbi_sql.h,
                        # which causes problems when generating DDL diffs. By adding 4, the constant becomes 13, a currently unused number.
