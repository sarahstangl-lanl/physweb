 ...
 * AjaxCheckbox
 * 
 * Based, off of InPlaceEditor.js
 */

var AjaxCheckbox = Class.create({
	initialize: function(id, url, args) {
		...
		this.container = $(id);
                ...
                this.currentValue = this.container.innerHTML

            this.viewingContainer = new Element('input');
            this.viewingContainer.type = "checkbox";
            this.viewingContainer.name = id;
            this.viewingContainer.value = 1;
            this.viewingContainer.checked = this.container.innerHTML == "1"?1:0;
	    ...
	    this.viewingContainer.observe('click', this.onClick.bindAsEventListener(this));
	},
	...
	onClick: function(e) {
                //if(this.currentValue != this.viewingContainer.value) {
                    this.startSaving(); 
                    this.savingValue = this.viewingContainer.checked?1:0;
                ...
                //}
                //else {
                //    alert('Current value not equal to container value');
                //}
	},
	/*
	onBlur: function(e) {		
	...
	*/
	onAjaxSuccess: function(transport) {
		...
		if (response && response.result == 'ok') {
			this.currentValue = this.savingValue?1:0;
		} else {
